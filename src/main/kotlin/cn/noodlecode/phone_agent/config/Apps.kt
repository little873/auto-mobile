 ...
 */
val ANDROID_APP_PACKAGES: Map<String, String> = mapOf(
    "科斯特换电" to "cn.net.cosbike",
    // Social & Messaging
    ...
    // Games
    "Pokemon Trading Card Game" to "jp.pokemon.pokemontcgp",
 ...
 * @return The Android package name, or null if not found.
 */
fun getPackageName(appName: String): String? {
    return ANDROID_APP_PACKAGES[appName]
}
 ...
 * @return The display name of the app, or null if not found.
 */
fun getAppName(packageName: String): String? {
    return ANDROID_APP_PACKAGES.entries.firstOrNull { it.value == packageName }?.key
}
...
fun listSupportedApps(): List<String> {
    return ANDROID_APP_PACKAGES.keys.toList()
}